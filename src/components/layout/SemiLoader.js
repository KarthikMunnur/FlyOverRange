...
export default class SemiLoader extends Component {
    render() {
        return (
            <div className="semiloader">
...
<g transform="rotate(0 50 50)">
  <rect x="47" y="24" rx="3" ry="6" width="6" height="12" fill="#43bee5">
