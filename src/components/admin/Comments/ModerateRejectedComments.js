...
class ModerateRejectedComments extends Component {
  constructor(props) {
    super(props);
  }
...
const mapStateToProps = (state) => {
  return {
    commentToDisplay: state.firestore.ordered.rejectedcomments,
...
export default compose(
  ...
  firestoreConnect([
    { collection: "rejectedcomments", orderBy: ["commentedAT", "asc"] },
  ])
)(ModerateRejectedComments);
